    ...
    <div class="container mt-3">
        ...
        <form id="entryform">
            <div class="form-group">
                <label for="name" class="col-sm-2 col-form-label">Name of Appellant</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label for="date" class="col-sm-3 col-form-label">Date of Appellant</label>
                <div class="col-md-6">
