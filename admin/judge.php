...
?>
    ...
    <div class="container mt-3">
        ...
        <form id="entryform">
            ...
            <div class="form-group">
                <label for="adate" class="col-sm-3 col-form-label">Date</label>
                <div class="col-md-6">
                    <input type="date" name="adate" class="form-control" id="adate" aria-describedby="adateHelp">
                </div>
            </div>
            <div class="form-group">
                <label for="judgement" class="col-sm-2 col-form-label">Judgement Reached</label>
                <div class="col-md-6">
